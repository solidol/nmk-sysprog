...
| `<iosfwd>` | Забезпечує [попередні оголошення](https://en.cppreference.com/w/cpp/header/iosfwd) декількох шаблонів класів, що мають справу з вводом/виводом.|
| `<iostream>` | Забезпечує основи введення в вивід в C++. Див. `iostream`. |
...
| `<sstream>` | Забезпечує шаблонний клас `std::stringstream` і інші допоміжні класи для маніпуляцій зі строками. |
...
| Заголовок | Опис |
|-------------------|---------------|
| `<complex>` | `<complex>` визначає шаблонний клас, і набір функцій для роботи з комплексними числами. |
