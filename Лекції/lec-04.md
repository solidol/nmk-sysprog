...
1. Які є основні типи операцій в C++, і як вони поділяються за функціональністю?
2. Як визначається приорітет операцій в складних виразах в C++, і як можна змінити порядок виконання операцій?
3. Що таке асоціативність операцій, і як вона впливає на порядок виконання виразів?
4. Як використовувати оператор sizeof для визначення розміру типу даних в байтах в C++?
5. Як використовувати операції присвоювання та як вони взаємодіють з іншими операціями в C++?Які основні арифметичні операції в C++, і як вони застосовуються до числових операндів?
6. Що таке операнд в контексті виразу в C++?
7. Як використовувати операції збільшення/зменшення (++ і --) у виразах C++?
8. Як визначити порядок виконання операцій у складних виразах за допомогою дужок?
9. Які операції з відношення та логічні операції існують в C++, і як вони впливають на умови?
10. Як використовувати тернарний оператор (? :) для створення умовних виразів?
11. Як використовувати оператор приведення типів для зміни типу операндів в виразах?
