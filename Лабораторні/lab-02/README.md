...
1. Написати дві програми для обчислення виразу відповідно до вашого варіанту та наступного.
    ...
    $$y=\frac{\sqrt{2+a^2-b}+|a|}{3b^2+1}+\sin a$$
