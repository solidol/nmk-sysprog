...
7.	Написати програму, що обчислює вираз  $` y = \frac{b+cos(c)}{2b+4\sqrt{a+c}-6tan(c)} `$  та скласти блок-схему
...
8.  Написати програму для обчислення завдання згідно з варіантом
    ...
    Варіант 10. Дано тризначне число. Вивести число, отримане при прочитанні вихідного
	числа справа наліво.
